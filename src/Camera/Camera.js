    ...
    var App = {
        ...
        attachListeners: function() {
            ...
            document.querySelector(".controls").addEventListener("click", function(e) {
                if (e.target && e.target.matches("button.stop")) {
                    e.preventDefault();
                    Quagga.stop();
            ...
            // start button
            document.querySelector(".controls").addEventListener("click", function(e) {
                if (e.target && e.target.matches("button.start")) {
                    e.preventDefault();
                    App.detachListeners();
                    Quagga.stop();
                    App.init();
            ...
            // config inputs/selects
            document
                .querySelector(".controls .reader-config-group")
                .addEventListener("change", function(e) {
                    if (e.target && (e.target.matches("input") || e.target.matches("select"))) {
                        ...
                        var state = self._convertNameToState(name);
